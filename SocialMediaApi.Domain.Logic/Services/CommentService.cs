...
namespace SocialMediaApi.Domain.Logic.Services
{
	public class CommentService : ICommentService
	{
		...
		public CommentService(SocialMediaApiDbContext dbContext, EventHandlerContainer publisher, IConfigService configService, IUserDetailsService userDetailsService)
		{
