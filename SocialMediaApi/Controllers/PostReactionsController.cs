...
namespace SocialMediaApi.Controllers
{
	...
	public class PostReactionsController : ControllerBase
	{
		...
		{
			return Ok(await _postReactionService.AddReactionAsync(this.GetAuthUser(), postId, model));
		}

		[HttpDelete]
		public async Task<ActionResult<CommentViewModel>> DeleteReactionAsync([FromRoute] Guid postId)
		{
			return Ok(await _postReactionService.DeleteReactionAsync(this.GetAuthUser(), postId));
		}
	}
}