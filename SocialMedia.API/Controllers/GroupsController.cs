...
public class GroupsController : ControllerBase
{
    ...
    public async Task<IActionResult> CreateGroup([FromBody] CreateGroupCommand command, CancellationToken cancellationToken)
    {
        ...
        var groupId = await _dispatcher.SendAsync<CreateGroupCommand, Guid>(commandWithCreator, cancellationToken);
        return Ok(groupId);
    }
    ...
    public async Task<IActionResult> AddUserToGroup(Guid groupId, Guid userId, CancellationToken cancellationToken)
    {
        ...
        await _dispatcher.SendAsync<AddUserToGroupCommand, bool>(command, cancellationToken);
        return Ok();
    }
    ...
    public async Task<IActionResult> RemoveUserFromGroup(Guid groupId, Guid userId, CancellationToken cancellationToken)
    {
        ...
        await _dispatcher.SendAsync<RemoveUserFromGroupCommand, bool>(command, cancellationToken);
        return Ok();
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var result = await _dispatcher.QueryAsync<GetPostsQuery, PagedResult<PostDto>>(query, cancellationToken);
        return Ok(result);
    }
    ...
    public async Task<IActionResult> GetGroups([FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 10, bool includeDefaults = false, CancellationToken cancellationToken = default)
    {
        ...
        var result = await _dispatcher.QueryAsync<GetGroupsQuery, PagedResult<GroupDto>>(query, cancellationToken);
        return Ok(result);
    }
    ...
    public async Task<IActionResult> GetGroup(Guid id, CancellationToken cancellationToken)
    {
        ...
        var result = await _dispatcher.QueryAsync<GetGroupQuery, GroupDto?>(query, cancellationToken);
        if (result == null)
        {
            return NotFound();
        }
    ...
    public async Task<IActionResult> UpdateGroup(Guid id, [FromBody] UpdateGroupCommand command, CancellationToken cancellationToken)
    {
        ...
        var result = await _dispatcher.SendAsync<UpdateGroupCommand, bool>(command, cancellationToken);
        if (!result)
        {
            return NotFound();
        }
    ...
    public async Task<IActionResult> DeleteGroup(Guid id, CancellationToken cancellationToken)
    {
        ...
        var result = await _dispatcher.SendAsync<DeleteGroupCommand, bool>(command, cancellationToken);
        if (!result)
        {
            return NotFound();
        }
    ...
    public async Task<IActionResult> CreatePoll(Guid groupId, [FromBody] CreatePollCommand command, CancellationToken cancellationToken)
    {
        ...
        var pollId = await _dispatcher.SendAsync<CreatePollCommand, Guid>(commandWithGroup, cancellationToken);
        return Ok(pollId);
    }
    ...
    public async Task<IActionResult> GetGroupPolls(Guid groupId, [FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 10, CancellationToken cancellationToken = default)
    {
        ...
        var result = await _dispatcher.QueryAsync<GetActivePollsQuery, PagedResult<PollDto>>(query, cancellationToken);
        return Ok(result);
    }
}