...
public class GetMostAttractivePostsQueryHandler : IQueryHandler<GetMostAttractivePostsQuery, PagedResult<PostDto>>
{
    private readonly IPostReadRepository _readRepository;
    private readonly IUserActivityRepository _userActivityRepository;

    public GetMostAttractivePostsQueryHandler(
