...
public class ReportsControllerTests(IntegrationTestWebApplicationFactory factory) : BaseControllerTests(factory)
{
    ...
    public async Task GetPendingReports_ShouldReturnReports_WhenReportsExist()
    {
        ...
        var getReportsResponse = await _client.GetAsync($"{Constants.ApiBase}/reports/pending", TestContext.Current.CancellationToken);
    ...
    public async Task GetPendingReports_ShouldReturnEmpty_WhenNoReportsExist()
    {
        ...
        // Act
        var response = await _client.GetAsync($"{Constants.ApiBase}/reports/pending", TestContext.Current.CancellationToken);
